...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2023 at 06:03 PM
...
CREATE TABLE `pms_user` (
  ...
  `u_position` varchar(100) NOT NULL COMMENT 'ตำแหน่งในบริษัท (หัวหน้า)',
...
INSERT INTO `pms_user` (`u_id`, `u_email`, `u_password`, `u_firstname`, `u_lastname`, `u_tel`, `u_position`, `u_createdate`, `u_status`, `u_creator`, `u_role`) VALUES
