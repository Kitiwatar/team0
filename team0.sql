...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 15, 2022 at 03:44 AM
...
INSERT INTO `pms_file` (`f_id`, `f_name`, `f_createdate`, `f_status`, `f_t_id`) VALUES
(9, '2022-10-13_701_1-65.png', '2022-10-13 18:17:15', 1, 11),
(10, '2022-10-13_701_1-65.png', '2022-10-13 19:08:13', 1, 12);
...
(29, 2, '2022-10-14 23:25:28', 0, 15, 16),
(30, 2, '2022-10-14 23:37:33', 0, 15, 17),
(31, 2, '2022-10-14 23:37:35', 0, 15, 18),
(32, 2, '2022-10-14 16:12:00', 0, 15, 19),
...
CREATE TABLE `pms_project` (
  ...
  `p_countdown` datetime DEFAULT NULL COMMENT 'กำหนดเวลากู้คืนโครงการ',
...
(15, 'พัฒนาระบบคลังสินค้าาาา', 'บริษัท .....', '0654012131', '', '', '', 'ระบบคลังสินค้าของบริษัท ......', '2022-09-30', NULL, 2),
(16, 'ระบบทะเบียน', 'โรงเรียน...', '0999999999', '', '', NULL, 'ระบบ...', '2022-10-06', NULL, -1),
(17, 'ระบบทะเบียน', 'โรงเรียน...', '0999999999', 'ex1', '', '', 'ระบบ...', '2022-10-06', NULL, -1),
(18, 'afs', 'afs', '', '', '', NULL, 'afs', '2022-10-06', NULL, -1),
(19, 'พัฒนาระบบคลังสินค้า', 'บริษัท .....', '0654012131', '', '', NULL, 'ระบบคลังสินค้าของบริษัท ......', '2022-09-30', NULL, -1),
(20, 'test', 'test', '', '', '', NULL, 'test', '2022-10-06', NULL, -1),
(21, 'wwww', 'wwwww', '', '', '', NULL, 'www', '2022-10-06', NULL, -1),
(22, 'test', 'test', '0999999999', 'adsads', 'test@aa.aa', 'asaesgasegaseg', 'aaads', '2022-10-14', NULL, -1),
(23, 'test', 'test', '', '', '', '', 'test', '2022-10-15', '2022-10-16 08:00:43', -1),
(24, 'testtest', 'ads', '', '', '', '', 'adsasd', '2022-10-15', '2022-10-15 07:26:00', -1);
...
(2, 'พูดคุย', '2022-10-11', 1, 1, 13, 20),
(3, 'test', '2022-10-13', 1, 1, 13, 11),
(4, 'test', '2022-10-13', 0, 1, 15, 11),
(5, 'test', '2022-10-12', 1, 1, 14, 11),
(6, 'test', '2022-10-13', 1, 1, 14, 11),
(7, 'te', '2022-10-12', 1, 1, 12, 11),
(8, 'asf', '2022-10-13', 0, 1, 15, 11),
(9, 'asdadsaadsasd', '2022-10-13', 0, 1, 15, 11),
(10, 'adsads', '2022-10-13', 0, 2, 15, 11),
(11, 'aljdshgjlashdgladsgdddasasfasa', '2022-10-13', 1, 1, 15, 11),
(12, 'test', '2022-10-14', 0, 5, 15, 11),
(13, 'test', '2022-10-14', 1, 1, 1, 20),
(14, 'adsadasdasddasasdads', '2022-10-14', 0, 1, 9, 20),
(15, 'test', '2022-10-14', 0, 1, 9, 11),
(16, 'test', '2022-10-14', 0, 1, 9, 11),
(17, 'dasafs', '2022-10-14', 0, 1, 9, 11),
(18, 'asfsaffsafs', '2022-10-14', 0, 1, 2, 11),
(19, 'test', '2022-10-15', 1, 1, 11, 11),
(20, 'ads', '2022-10-14', 1, 1, 10, 11),
(21, 'test', '2022-10-15', 1, 4, 10, 11),
(22, 'ads', '2022-10-15', 0, 1, 24, 11);
...
(29, 'test1@gmail.com', '4b4a2343f93add9ff848a09647b275f955a64575e200d5b743d2a30a29480e06', 'testtest', 'testt', '0922222222', '2022-10-05 18:36:56', 0, 11, 3);
...
--
ALTER TABLE `pms_file`
  MODIFY `f_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีไฟล์ (ตัวอย่าง 1)', AUTO_INCREMENT=11;
...
--
ALTER TABLE `pms_permission`
  MODIFY `per_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีสิทธิ์ (ตัวอย่าง 1)', AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `pms_project`
--
ALTER TABLE `pms_project`
  MODIFY `p_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีโครงการ (ตัวอย่าง 1)', AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `pms_task`
--
ALTER TABLE `pms_task`
  MODIFY `t_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีกิจกรรม (ตัวอย่าง 1)', AUTO_INCREMENT=23;
