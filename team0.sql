-- Create by: Patiphan Pansanga, Jiradat Pomyai 25-09-2565
...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 25, 2022 at 05:16 PM
...
CREATE TABLE `pms_project` (
  ...
  `p_customer` varchar(100) NOT NULL COMMENT 'ชื่อลูกค้า (ตัวอย่าง จักรภพ สุวรรณวงศ์)',
  `p_contact` varchar(100) NOT NULL COMMENT 'ช่องทางติดต่อลูกค้า (ตัวอย่าง line: jackzaza)',
...
INSERT INTO `pms_project` (`p_id`, `p_name`, `p_customer`, `p_contact`, `p_detail`, `p_createdate`, `p_status`) VALUES
...
(2, 'Document Management System', 'ภาธร วิเชียรชาญ', '0601422517', 'ระบบจัดการไฟล์เอกสารในบริษัท', '2022-08-01', 3),
...
(13, 'ระบบร้านกาแฟ', 'กุลจิรา สิริวาณิชย์', 'line: kuljira', 'ระบบจัดการร้านกาแฟ', '2022-09-24', 1),
...
--
ALTER TABLE `pms_permission`
  MODIFY `per_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีสิทธิ์ (ตัวอย่าง 1)', AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `pms_project`
--
ALTER TABLE `pms_project`
  MODIFY `p_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีโครงการ (ตัวอย่าง 1)', AUTO_INCREMENT=15;
...
--
ALTER TABLE `pms_tasklist`
  MODIFY `tl_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีชื่อกิจกรรม (ตัวอย่าง 1)', AUTO_INCREMENT=4;
