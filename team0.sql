...
(25, 1, '2022-10-06 10:17:19', 1, 21, 11);
...
INSERT INTO `pms_project` (`p_id`, `p_name`, `p_customer`, `p_telcontact`, `p_linecontact`, `p_emailcontact`, `p_othercontact`, `p_detail`, `p_createdate`, `p_status`) VALUES
...
(2, 'Document Management System', 'ภาธร วิเชียรชาญ', '0601422517', NULL, NULL, NULL, 'ระบบจัดการไฟล์เอกสารในบริษัท', '2022-08-01', 3),
...
(13, 'ระบบร้านกาแฟ', 'กุลจิรา สิริวาณิชย์', '0811919111', NULL, NULL, NULL, 'ระบบจัดการร้านกาแฟ', '2022-09-24', 1),
...
(15, 'พัฒนาระบบคลังสินค้า', 'บริษัท .....', '0654012131', NULL, NULL, NULL, 'ระบบคลังสินค้าของบริษัท ......', '2022-09-30', 1),
(16, 'ระบบทะเบียน', 'โรงเรียน...', '0999999999', '', '', NULL, 'ระบบ...', '2022-10-06', -1),
(17, 'ระบบทะเบียน', 'โรงเรียน...', '0999999999', 'ex1', '', '', 'ระบบ...', '2022-10-06', 1),
(18, 'afs', 'afs', '', '', '', NULL, 'afs', '2022-10-06', -1),
(19, 'พัฒนาระบบคลังสินค้า', 'บริษัท .....', '0654012131', '', '', NULL, 'ระบบคลังสินค้าของบริษัท ......', '2022-09-30', 1),
(20, 'test', 'test', '', '', '', NULL, 'test', '2022-10-06', -1),
(21, 'wwww', 'wwwww', '', '', '', NULL, 'www', '2022-10-06', -1);
...
(27, 'ponganan@gmail.com', '7e77ef5235e0cfa21343ce5fc578ac8e91c1a30caa8407e2fcd501653b72d35e', 'พงษ์อนันต์', 'ตั้งตระกูลเจริญ', '0698812215', '2022-09-20 06:06:33', 1, 11, 3),
...
--
ALTER TABLE `pms_permission`
  MODIFY `per_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีสิทธิ์ (ตัวอย่าง 1)', AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `pms_project`
--
ALTER TABLE `pms_project`
  MODIFY `p_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีโครงการ (ตัวอย่าง 1)', AUTO_INCREMENT=22;
