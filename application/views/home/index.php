        ...
        <div class="col-lg-4 col-md-4">
            <div class="card border ">
                    ...
                    <div class="card-body">
                        ...
                        <span class="text-muted fs-5">โครงการทั้งหมด</span><span class="float-end text-muted" style="font-size: 12px;"><a href="<?= base_url() ?>home/viewProjects/all"><button class="btn  waves-effect waves-light btn-outline-info">ดูเพิ่มเติม...</button></a></span> 
        ...
        <div class="col-lg-4 col-md-4">
            <div class="card border">               
                    <div class="card-body">
                        ...
                        <span class="text-muted fs-5">รอดำเนินการ</span><span class="float-end text-muted" style="font-size: 12px;"><a href="<?= base_url() ?>home/viewProjects/pending"><button class="btn  waves-effect waves-light btn-outline-info">ดูเพิ่มเติม...</button></a></span>
